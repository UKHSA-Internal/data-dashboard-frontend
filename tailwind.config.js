...
module.exports = {
  ...
  theme: {
    ...
    colors: ({ colors }) => ({
      ...
      'colour-1-dark-blue': 'var(--colour-map-dark-blue)',
      'colour-2-turquoise': 'var(--colour-map-turquoise)',
      'colour-3-dark-pink': 'var(--colour-map-dark-pink)',
      'colour-4-orange': 'var(--colour-map-orange)',
      'colour-5-dark-grey': 'var(--colour-map-dark-grey)',
      'colour-6-light-purple': 'var(--colour-map-light-purple)',
      'colour-7-burgundy': 'var(--colour-map-burgundy)',
      'colour-8-mustard': 'var(--colour-map-mustard)',
      'colour-9-deep-plum': 'var(--colour-map-deep-plum)',
      'colour-10-pink': 'var(--colour-map-pink)',
      'colour-11-khaki': 'var(--colour-map-khaki)',
      'colour-12-blue': 'var(--colour-map-blue)',
    }),
    extend: {
      backgroundImage: {
