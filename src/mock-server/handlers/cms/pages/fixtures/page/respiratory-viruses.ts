...
export const respiratoryVirusesMock: PageResponse<PageType.Composite> = {
  ...
  meta: {
    ...
    detail_url: 'https://http:/api/pages/80/',
    html_url: 'https://http://localhost:3000/respiratory-viruses/',
      ...
      value: [
        ...
        },
        {
          ...
          value: {
            ...
            page: 'https://http://localhost:3000/topics/influenza/',
          },
        ...
        },
        {
          ...
          value: {
            ...
            page: 'https://http://localhost:3000/topics/other-respiratory-viruses/',
          },
