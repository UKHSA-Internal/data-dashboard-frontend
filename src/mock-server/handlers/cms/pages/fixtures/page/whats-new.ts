...
export const whatsNewParentMock: PageResponse<PageType.WhatsNewParent> = {
  ...
  meta: {
    ...
    html_url: 'http://localhost:3000/whats-new',
    slug: 'whats-new',
    show_in_menus: true,
...
export const whatsNewChildMocks: PageResponse<PageType.WhatsNewChild>[] = [
  {
    ...
    meta: {
      ...
      detail_url: 'http://localhost:3000/api/pages/22/',
      html_url: 'http://localhost:3000/whats-new/soft-launch-of-the-ukhsa-data-dashboard',
  ...
  },
  {
    ...
    meta: {
      ...
      search_description: '',
      type: 'whats_new.WhatsNewChildEntry',
      detail_url: 'http://localhost:3000/api/pages/23/',
      html_url: 'http://localhost:3000/whats-new/updated-csv-download-and-tabular-data-functionality',
  ...
  },
  {
    ...
    meta: {
      ...
      search_description: '',
      type: 'whats_new.WhatsNewChildEntry',
      detail_url: 'http://localhost:3000/api/pages/24/',
      html_url: 'http://localhost:3000/whats-new/other-respiratory-viruses-data-added-to-the-homepage',
  ...
  ...Array.from({ length: 30 }).map<PageResponse<PageType.WhatsNewChild>>((item, index) => ({
    ...
    meta: {
      ...
      type: 'whats_new.WhatsNewChildEntry',
      detail_url: 'http://localhost:3000/api/pages/24/',
      html_url: `http://localhost:3000/whats-new/whats-new-child-mock-${index + 1}`,
