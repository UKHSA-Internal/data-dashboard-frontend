...
export const metricsParentMock: PageResponse<PageType.MetricsParent> = {
  ...
  meta: {
    ...
    html_url: 'http://localhost:3000/metrics-documentation',
...
export const metricsChildMocks: PageResponse<PageType.MetricsChild>[] = [
  {
    ...
    meta: {
      ...
      detail_url: 'http://localhost:3000/api/pages/26/',
      html_url: 'http://localhost:3000/metrics-documentation/new-cases-7days-sum',
  ...
  },
  {
    ...
    meta: {
      ...
      search_description: '',
      type: 'metrics_documentation.MetricsDocumentationChildEntry',
      detail_url: 'http://localhost:3000/api/pages/27/',
      html_url: 'http://localhost:3000/metrics-documentation/new-deaths-7days-change-percentage',
  ...
  },
  {
    ...
    meta: {
      ...
      search_description: '',
      type: 'metrics_documentation.MetricsDocumentationChildEntry',
      detail_url: 'http://localhost:3000/api/pages/28/',
      html_url: 'http://localhost:3000/metrics-documentation/covid-occupied-beds-latest',
  ...
  },
  {
    ...
    meta: {
      ...
      search_description: '',
      type: 'metrics_documentation.MetricsDocumentationChildEntry',
      detail_url: 'http://localhost:3000/api/pages/29/',
      html_url: 'http://localhost:3000/metrics-documentation/new-pcr-tests-daily',
  ...
  },
  {
    ...
    meta: {
      ...
      type: 'metrics_documentation.MetricsDocumentationChildEntry',
      detail_url: 'http://localhost:3000/api/pages/26/',
      html_url: 'http://localhost:3000/metrics-documentation/new-cases-7days-percent',
  ...
  ...Array.from({ length: 50 }).map<PageResponse<PageType.MetricsChild>>((item, index) => ({
    ...
    meta: {
      ...
      type: 'metrics_documentation.MetricsDocumentationChildEntry',
      detail_url: 'http://localhost:3000/api/pages/29/',
      html_url: `http://localhost:3000/metrics-documentation/metrics-child-mock-${index + 1}`,
