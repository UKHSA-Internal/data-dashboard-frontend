  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: dashboardMock.meta.seo_change_frequency,
        seo_priority: dashboardMock.meta.seo_priority,
      },
  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: aboutPageMock.meta.seo_change_frequency,
        seo_priority: aboutPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: cookiesPageMock.meta.seo_change_frequency,
        seo_priority: cookiesPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: accessibilityStatementPageMock.meta.seo_change_frequency,
        seo_priority: accessibilityStatementPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: compliancePageMock.meta.seo_change_frequency,
        seo_priority: compliancePageMock.meta.seo_priority,
      },
  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: archiveDataPageMock.meta.seo_change_frequency,
        seo_priority: archiveDataPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: bulkDownloadsPageMock.meta.seo_change_frequency,
        seo_priority: bulkDownloadsPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: accessOurDataParentMock.meta.seo_change_frequency,
        seo_priority: accessOurDataParentMock.meta.seo_priority,
      },
    ...
    ),
    {
      ...
      meta: {
        ...
        seo_change_frequency: weatherHealthAlertsParentMock.meta.seo_change_frequency,
        seo_priority: weatherHealthAlertsParentMock.meta.seo_priority,
      },
  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: covid19PageMock.meta.seo_change_frequency,
        seo_priority: covid19PageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: influenzaPageMock.meta.seo_change_frequency,
        seo_priority: influenzaPageMock.meta.seo_priority,
      },
    ...
    },
    {
      ...
      meta: {
        ...
        seo_change_frequency: otherRespiratoryVirusesPageMock.meta.seo_change_frequency,
        seo_priority: otherRespiratoryVirusesPageMock.meta.seo_priority,
      },
  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: whatsNewParentMock.meta.seo_change_frequency,
        seo_priority: whatsNewParentMock.meta.seo_priority,
      },
...
export const pagesWithWhatsNewChildTypeMock: WhatsNewPagesResponse = {
  ...
  items: whatsNewChildMocks.map(
    ({
      id,
      title,
      meta: { type, detail_url, html_url, slug, show_in_menus, first_published_at, seo_priority, seo_change_frequency },
      date_posted,
      additional_details,
      badge,
      body,
  ...
  items: [
    {
      ...
      meta: {
        ...
        seo_change_frequency: metricsParentMock.meta.seo_change_frequency,
        seo_priority: metricsParentMock.meta.seo_priority,
      },
...
export const pagesWithMetricsChildTypeMock: PagesResponse = {
  ...
  items: metricsChildMocks.map(
    ({
      id,
      title,
      meta: { type, detail_url, html_url, slug, show_in_menus, first_published_at, seo_change_frequency, seo_priority },
      page_description,
      metric_group,
      topic,
      metric,
