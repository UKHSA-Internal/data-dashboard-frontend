...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/app/components/ui/ukhsa'
        ...
        return (
          ...
          >
            <article
              ...
              className="ukhsa-chart-card govuk-!-padding-4 flex flex-col gap-6 bg-grey-3"
            >
                ...
                <TabsList className="hidden no-js:block sm:block">
                  ...
                  >
                    <Link href={`#chart-${kebabCase(column.value.title)}`}>
                      <span className="govuk-visually-hidden">Chart</span>
                  ...
                  >
                    <Link href={`#download-${kebabCase(column.value.title)}`}>
                      <span className="govuk-visually-hidden">Download</span>
