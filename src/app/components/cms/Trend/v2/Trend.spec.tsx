...
describe('Data request is successful', () => {
  test('renders upward positive trend correctly', async () => {
    ...
    expect(getByText('Increase of 592 (3%) compared to the previous 7 days.')).toBeInTheDocument()
  })
  ...
  test('renders downward positive trend correctly', async () => {
    ...
    expect(getByText('Decrease of -592 (-3%) compared to the previous 7 days.')).toBeInTheDocument()
  })
  ...
  test('formats trend values and percentages with multiple decimal places into a two decimal format', async () => {
    ...
    expect(getByText('Decrease of -592.12 (3.68%) compared to the previous 7 days.')).toBeInTheDocument()
  })
