...
import { PopularTopicsCardHeightSync } from './PopularTopicsCardHeightSync'
          ...
          {value.right_column_bottom_row.length > 0 && (
            ...
            >
              {value.right_column_bottom_row.map((card: PopularTopicsCardData['right_column_bottom_row'][number]) => (
                <Card
                  key={card.id}
                  className="ukhsa-headline-metric-card govuk-!-margin-bottom-0"
