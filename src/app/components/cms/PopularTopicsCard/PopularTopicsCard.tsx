            ...
            {value.right_column_top_row.map((card: PopularTopicsCardData['right_column_top_row'][number]) => {
              ...
              return (
                <Card
                  ...
                  className="ukhsa-chart-card relative flex h-full flex-col border border-black bg-[var(--colour-home-chart-background)] no-underline transition-colors duration-200 ukhsa-focus hover:bg-[var(--colour-home-chart-background-hover)] focus:border-black focus:bg-[var(--colour-home-chart-background-hover)]"
                >
