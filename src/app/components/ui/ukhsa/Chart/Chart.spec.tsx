...
test('full width charts should also have an acompanying narrow version for mobile viewports', async () => {
  ...
  expect(getByTestId('chart')).toHaveAttribute('srcset', 'data:image/svg+xml;utf8,mock-chart-wide')
  expect(getByTestId('chart')).toHaveAttribute('media', '(min-width: 768px)')
})
...
test('landing page half width charts should also have an acompanying third width version for mobile viewports', async () => {
  ...
  expect(getByTestId('chart')).toHaveAttribute('srcset', 'data:image/svg+xml;utf8,mock-chart-third')
})
