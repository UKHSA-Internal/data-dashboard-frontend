  ...
  return (
    <section className="govuk-notification-banner" aria-labelledby="govuk-notification-banner-title">
      ...
      <div className="govuk-notification-banner__content">
        ...
        <p className="govuk-body whitespace-nowrap">
          The embargo-controlled information in this page, if any, is displayed as if viewing it on {formattedDate}.
        </p>
        <p className="govuk-body">This is for the purpose of preview before publication.</p>
