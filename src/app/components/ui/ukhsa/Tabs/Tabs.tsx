...
const TabsTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger> & { backgroundWhite?: boolean }
>(({ className, children, backgroundWhite, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={clsx(
        ...
        'relative float-left ml-0 text-center js:mb-0 js:mr-1 js:px-[8px] no-js:clear-both no-js:mb-2 js:sm:px-3 js:sm:py-2 js:lg:px-2',
        {
          'js:bg-white': backgroundWhite,
          'js:bg-light-grey': !backgroundWhite,
        },
