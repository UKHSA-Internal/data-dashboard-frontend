...
const TabsTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger> & { backgroundWhite?: boolean; wideTab?: boolean }
>(({ className, children, backgroundWhite, wideTab, ...props }, ref) => {
