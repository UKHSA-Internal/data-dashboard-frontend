  ...
  return (
    <div ref={topNavRef} className="print:hidden">
      <div className="govuk-width-container relative">
        <Link
          className={clsx(
            'govuk-!-font-size-16 ukhsa-chevron govuk-link govuk-link--inverse group absolute -top-9 right-0 z-10 flex h-9 items-center px-4 font-bold no-underline shadow-none motion-reduce:transition-none md:-top-9',
            {
