...
describe('FilterBanner', () => {
  ...
  test('renders message with icon when showIcon is true', () => {
    const { getByText, container } = render(<FilterBanner message={testMessage} showIcon={true} />)
    ...
    expect(container.firstChild).toHaveClass('govuk-!-padding-3 flex bg-blue text-white')
  })

  test('renders message without icon when showIcon is false', () => {
    const { getByText, container } = render(<FilterBanner message={testMessage} showIcon={false} />)
  ...
  test('renders correctly when showIcon is undefined', () => {
    const { getByText, container } = render(<FilterBanner message={testMessage} />)
