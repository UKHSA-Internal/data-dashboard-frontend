...
export enum MapFeatureColour {
  ...
  Yellow = 'Yellow',
  Red = 'Red',
  MAP_COLOUR_1_LIGHT_GREEN = 'MAP_COLOUR_1_LIGHT_GREEN',
  MAP_COLOUR_2_TURQUOISE = 'MAP_COLOUR_2_TURQUOISE',
  MAP_COLOUR_3_BLUE = 'MAP_COLOUR_3_BLUE',
  MAP_COLOUR_4_DARK_BLUE = 'MAP_COLOUR_4_DARK_BLUE',
}
...
export enum ColourVariableMap {
  ...
  Red = 'var(--colour-red)',
  MAP_COLOUR_1_LIGHT_GREEN = 'var(--colour-map-light-green-semi)',
  MAP_COLOUR_2_TURQUOISE = 'var(--colour-map-turquoise-semi)',
  MAP_COLOUR_3_BLUE = 'var(--colour-map-blue-semi)',
  MAP_COLOUR_4_DARK_BLUE = 'var(--colour-map-dark-blue-semi)',
}
...
export enum HoverColourVariableMap {
  ...
  MAP_COLOUR_1_LIGHT_GREEN = 'var(--colour-map-light-green-hover)',
  MAP_COLOUR_2_TURQUOISE = 'var(--colour-map-turquoise-hover)',
  MAP_COLOUR_3_BLUE = 'var(--colour-map-blue-hover)',
  MAP_COLOUR_4_DARK_BLUE = 'var(--colour-map-dark-blue-hover)',
}
...
export enum ActiveColourVariableMap {
  ...
  MAP_COLOUR_1_LIGHT_GREEN = 'var(--colour-map-light-green)',
  MAP_COLOUR_2_TURQUOISE = 'var(--colour-map-turquoise)',
  MAP_COLOUR_3_BLUE = 'var(--colour-map-blue)',
  MAP_COLOUR_4_DARK_BLUE = 'var(--colour-map-dark-blue)',
}
