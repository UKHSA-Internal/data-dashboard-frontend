...
export async function POST(req: NextRequest) {
  try {
    ...
    logger.info('Feedback success - redirecting: ', JSON.stringify(req))

    return NextResponse.redirect(new URL('/feedback/confirmation', req.nextUrl.origin), 302)
  } catch (error) {
    ...
    return NextResponse.redirect(new URL('/feedback/?error=1', req.nextUrl.origin), 302)
  }
}
