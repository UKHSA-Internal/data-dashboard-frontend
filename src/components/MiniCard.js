...
function MiniCard(props) {
    const trendArrowImg = trendArrow(props.trendArrow)
    return (
                            ...
                            <div className="float govuk-heading-m govuk-!-margin-bottom-0 govuk-!-padding-top-0 total-figure2">
                                <span className="govuk-link--no-visited-state number-link-red">
                                    <b className={`govuk-tag number govuk-!-margin-top-1 change-box ${props.trendRAG}`}>
                                        <img src={trendArrowImg} alt="Direction arrow" width="12px" aria-hidden="true" className="govuk-!-margin-right-1" />
...
function trendArrow(trendDirection) {
    ...
    switch (trendDirection) {
        case "up-red":
            arrow = "https://coronavirus.data.gov.uk/public/assets/summary/images/arrow-up-red.png";
            break;
        case "down-green":
            arrow = "https://coronavirus.data.gov.uk/public/assets/summary/images/arrow-up-green.png";
            break;
        default:
            arrow = "https://coronavirus.data.gov.uk/public/assets/summary/images/arrow-up-grey.png";
    }
    return arrow
}
