/**
 * NPM packages that aren't written in TypeScript or don't
 * expose a DefinitelyTyped package need to be declared as modules in here.
 */
...
declare module 'govuk-colours' {
  ...
  export const DEPARTMENT_FOR_COMMUNITIES_AND_LOCAL_GOVERNMENT_WEBSAFE =
    '#37836e'
