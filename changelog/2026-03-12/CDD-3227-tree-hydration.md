...
| src/config/test-utils.tsx   | Provide custom render for tests, enforce lint rules                               | React components for testing. Example: `render(<Component />)`                       | Wraps components with providers, re-exports render for tests.                                              | Custom render function for consistent test setup.                                                         |
