...
}, ...compat.extends("plugin:@typescript-eslint/recommended"), ...compat.extends("plugin:import/recommended"), ...compat.extends("plugin:tailwindcss/recommended"), ...next, ...nextCoreWebVitals, ...compat.extends("prettier"), {
  plugins: {
