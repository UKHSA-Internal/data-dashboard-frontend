...
test.describe('WHA region page desktop tests @desktopOnly', () => {
  test.use({ viewport: viewports.desktop })

  test('Expect not to see cold alert icon', async ({ app, weatherHealthAlertsRegionPage }) => {
    ...
    await test.step('has alert banner', async () => {
      await weatherHealthAlertsRegionPage.hasAlertBanner('cold', 'Red')
    })
  })
})

test.describe('WHA region page mobile tests @mobileOnly', () => {
  ...
  test('Expect not to see cold alert icon', async ({ app, weatherHealthAlertsRegionPage }) => {
    ...
    await test.step('has mobile alert banner', async () => {
      await weatherHealthAlertsRegionPage.hasMobileAlertBanner('cold', 'Red')
    })
  })
})
